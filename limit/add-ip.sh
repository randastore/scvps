...
data_ip="https://raw.githubusercontent.com/randastore/scvps/main/izinIP"
checking_sc() {
...
checking_sc
clear
Repo1="https://raw.githubusercontent.com/randastore/scvps/main/"
cd izinIp
...
URL="https://api.telegram.org/bot$KEY/sendMessage"
   ...
   # read -p "  Input Username IP (Example : Lt) : " name
    ...
    git remote add origin https://github.com/randastore/scvps
    git push -f https://${TOKEN}@github.com/randastore/scvps.git &> /dev/null
    cd izinIp
    rm -rf /root/scvps
    clear
    sleep 1
